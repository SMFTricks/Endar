...
function template_pick()
{
	...
	foreach ($context['available_themes'] as $theme)
		echo '
	<div class="border" style="min-width:1px;">
	<h3 class="', $theme['selected'] ? 'title2' : 'title', '"><a href="', $scripturl, '?action=theme;sa=pick;u=', $context['current_member'], ';th=', $theme['id'], ';sesc=', $context['session_id'], '">', $theme['name'], '</a></h3>
	<div class="row1">
	<div class="float-r" style="margin-left:10px;"><img src="', $theme['thumbnail_href'], '" alt="" /></div>
	<p>', $theme['description'], '</p><br />
	<p><em>', $theme['num_users'], ' ', ($theme['num_users'] == 1 ? $txt['theme_user'] : $txt['theme_users']), '</em></p>
	<br />
	<div class="buttons"><a href="', $scripturl, '?action=theme;sa=pick;u=', $context['current_member'], ';th=', $theme['id'], ';sesc=', $context['session_id'], '">', $txt['theme_set'], '</a> 
	&nbsp; 
