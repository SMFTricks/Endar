...
function template_main()
{
	...
	echo '
		...
		<div class="border">
		<h3 class="title">', $txt['months_titles'][$context['current_month']], ' ', $context['current_year'], '</h3>
		<div class="row1">
	...
	foreach ($context['week_days'] as $day)
		echo '
				<th class="catbg" width="14%" align="center">', $txt['days'][$day], '</th>';
	echo '
			</tr>';
	...
	foreach ($context['weeks'] as $week)
	{
		...
		foreach ($week['days'] as $day)
		{
			...
			echo '
				<td valign="top" style="height: 100px; padding: 2px;" class="', $day['is_today'] ? 'calendar_today' : 'stripe-row' , '">';
			...
			if (!empty($day['day']))
			{
				...
				if (!empty($modSettings['cal_daysaslink']) && $context['can_post'])
						echo '
					<strong><a href="', $scripturl, '?action=calendar;sa=post;month=', $context['current_month'], ';year=', $context['current_year'], ';day=', $day['day'], ';sesc=', $context['session_id'], '">', $day['day'], '</a></strong>';
					else
						echo '
				...
				if ($day['is_first_day'])
					echo '<span class="smalltext"><strong> - ', $txt['calendar51'], ' ', $week['number'], '</strong></span>';
				...
				if (!empty($day['events']))
				{
					...
					foreach ($day['events'] as $event)
					{
						...
						if ($event['can_edit'])
							echo '
						<a href="', $event['modify_href'], '" style="color: #990000;">*</a> ';
...
<div class="row1-center">
	...
	if (isset($context['previous_calendar']))
		echo '
			<span class="float-l"><strong><a href="', $context['previous_calendar']['href'], '">&#171; ', $txt['months_short'][$context['previous_calendar']['month']], ' ', $context['previous_calendar']['year'], '</a></strong></span>';
			
	// Is there a calendar for next month?
	if (isset($context['next_calendar']))
		echo '
			<span class="float-r"><strong><a href="', $context['next_calendar']['href'], '">' . $txt['months_short'][$context['next_calendar']['month']] . ' ' . $context['next_calendar']['year'] . ' &#187;</a></strong></span>';
	...
	echo '
						...
						<input type="submit" class="button" value="', $txt[305], '" />';
	...
	if ($context['can_post'])
		echo '
			<br /><br />
			<div class="buttons">
			<a href="', $scripturl, '?action=calendar;sa=post;month=', $context['current_month'], ';year=', $context['current_year'], ';sesc=', $context['session_id'], '">' . $txt['calendar23'] . '</a>
			</div>';
...
function template_event_post()
{
	...
	{
		echo '
							<div class="row2"', $context['error_type'] == 'serious' ? '<strong>' . $txt['error_while_submitting'] . '</strong>' : '', '
	...
	echo '
		<div class="subtitle">
		<strong', isset($context['post_error']['no_event']) ? ' style="color: #990000;"' : '', '>', $txt['calendar12'], '</strong>
		</div>
		<div class="row1">
	...
	{
		echo '
			<span class="formleft"><strong>', $txt['calendar54'], '</strong></span>
			<span class="formright"><select name="span">';
	...
	{
		echo '
				<span class="formleft"><strong>', $txt['calendar_link_event'], '</strong></span>
				<span class="formright"><input type="checkbox" class="check" name="link_to_board" checked="checked" onclick="toggleLinked(this.form);" /></span>
				
				<span class="formleft"><strong>', $txt['calendar13'], '</strong></span>
				<span class="formright"><select id="board" name="board" onchange="this.form.submit();">';
	...
	echo '
		...
		<div class="subtitle" style="text-align:center;">
									<input type="submit" class="button" value="', empty($context['event']['new']) ? $txt[10] : $txt[105], '" />';
	// Delete button?
	if (empty($context['event']['new']))
		echo '
									<input type="submit" class="button" name="deleteevent" value="', $txt['calendar22'], '" onclick="return confirm(\'', $txt['calendar_confirm_delete'], '\');" />';
